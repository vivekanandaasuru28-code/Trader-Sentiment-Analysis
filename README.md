...
Fear → Investors are cautious or panic-driven
...
Trading behavior (risk-taking, trade size)
...
Created win (profit/loss indicator)
Identified trading direction (long/short)
